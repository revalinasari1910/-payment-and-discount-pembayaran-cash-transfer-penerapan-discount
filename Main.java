...
public class Main {
    public static void main(String[] args) {
        ...
        switch (pilihanDiskon) {
            case 2:
                diskon = Diskon.persen(10, 20000);
                break;
            case 3:
                diskon = Diskon.nominal(10000, 50000);
                break;
            case 4:
                System.out.print("Apakah pelanggan member? (y/n): ");
                boolean isMember = sc.next().equalsIgnoreCase("y");
                diskon = Diskon.member(isMember, 10);
                break;
            default:
                diskon = Diskon.tanpaDiskon();
                break;
        }
        ...
        try {
            ...
            if (diskon.isDiskonMemberAktif()) {
                Diskon.tambahPoin("MEMBER001", pembayaran.getTotalBayar());
                System.out.println("Poin member sekarang: " + Diskon.cekPoin("MEMBER001"));
            }
